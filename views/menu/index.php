                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="col-sm-6">
                                ...
                                <p>Найсмачніша їжа швидкого приготування у вашому місті. Перевірена якість та доступна ціна.</p>
                        ...
                        <div class="item">
                            <div class="col-sm-6">
                                ...
                                <p>Ми дбаємо про наших відвідувачів та слідкуємо за приготування кожної страви, а також за оформленням кожного замовлення.</p>
                                <button type="button" class="btn btn-default get">Перейти до меню</button>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="item">
                            <div class="col-sm-6">
                                ...
                                <p>Продукти, з яких виготовляються страви, пройшли термальну обробку та мають найвищий знак якості.</p>
                                <button type="button" class="btn btn-default get">Перейти до меню</button>
                            </div>
                            <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                ...
                <div class="features_items">
                    <h2 class="title text-center">Меню</h2>
                                ...
                                <div class="dish-image-wrapper">
                                    <div class="single-products">
                                        <div class="dish text-center">
                                            <?= Html::img($mainImg->getUrl(), ['alt' => [$dish->name],'height' => 230]); ?>
                                            <h2><?= $dish->price ?> грн</h2>
                                            <p>
                                                <a href="<?= Url::to(['dish/view', 'id' => $dish->id]) ?>"><?= $dish->name ?></a>
                                            </p>
                                            <a href="<?= Url::to(['cart/add', 'id' => $dish->id]) ?>"
                                               data-id="<?= $dish->id ?>" class="btn btn-default add-to-cart"><i
